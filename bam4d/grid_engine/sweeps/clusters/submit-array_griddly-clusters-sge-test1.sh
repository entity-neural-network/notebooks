...
exp_name_values=( griddly-clusters-sge-test1 )
track_values=( True )
total_timesteps_values=( 10000000 )
processes_values=( 8 )
num_envs_values=( 4096 )
...
data_dir_values=( /data/scratch/acw434/griddly-clusters-sge-test1 )
trial=${SGE_TASK_ID}
