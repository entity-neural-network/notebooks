...
#$ -pe smp 8
#$ -l h_vmem=11G
#$ -N griddly-clusters-generated-param-sweep-translation-rotation
#$ -l gpu=1
#$ -l gpu_type=ampere
#$ -l cluster=andrena
#$ -l h_rt=6:0:0
...
exp_name_values=( griddly-clusters-generated-param-sweep-translation-rotation )
track_values=( True )
...
learning_rate_values=( 0.05 0.001 0.005 )
seed_values=( 0 1 )
ent_coef_values=( 0.01 0.005 0.001 )
...
data_dir_values=( /data/scratch/acw434/griddly-clusters-generated-param-sweep-translation-rotation )
trial=${SGE_TASK_ID}
