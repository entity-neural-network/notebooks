...
#$ -pe smp 8
#$ -l h_vmem=11G
#$ -N griddly-clusters-generated-seed-sweep-translated
#$ -l gpu=1
#$ -l gpu_type=ampere
#$ -l cluster=andrena
#$ -l h_rt=6:0:0
...
exp_name_values=( griddly-clusters-generated-seed-sweep-translated )
track_values=( True )
...
data_dir_values=( /data/scratch/acw434/griddly-clusters-generated-seed-sweep-translated )
trial=${SGE_TASK_ID}
