...
#$ -pe smp 8
#$ -l h_vmem=11G
#$ -N griddly-clusters-multi-generated-seed-sweep
#$ -l gpu=1
#$ -l gpu_type=ampere
#$ -l cluster=andrena
#$ -l h_rt=1:0:0
...
exp_name_values=( griddly-clusters-multi-generated-seed-sweep )
track_values=( True )
...
data_dir_values=( /data/scratch/acw434/griddly-clusters-multi-generated-seed-sweep )
trial=${SGE_TASK_ID}
