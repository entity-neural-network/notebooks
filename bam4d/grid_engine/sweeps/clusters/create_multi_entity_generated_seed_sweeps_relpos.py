...
if __name__ == '__main__':
    ...
    job_name = 'griddly-clusters-multi-generated-seed-sweep-relpos'
    script = get_script(
        {
            'sge_time_h': 6,
        ...
        {
            'gym-id': ['GDY-Clusters-Multi-Generated-Small', 'GDY-Clusters-Multi-Generated-Medium', 'GDY-Clusters-Multi-Generated-Large'],
            'exp-name': [f'{job_name}'],
            'track': ['True'],
